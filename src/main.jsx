...
function Coach({ responses, profiles, pendingProfiles, onProfilesChange, activeProfilesToday, code, loading, onLogout, onClear }) {
  ...
  return (
    <main className="coach-shell">
      <header><ClubBrand /><details className="coach-header-menu"><summary><span className="coach-badge">Tränarvy⌄</span></summary><div><button type="button" onClick={() => { const toolsMenu = document.querySelector('.coach-tools-menu'); if (toolsMenu) { toolsMenu.open = true; toolsMenu.scrollIntoView({ behavior: 'smooth', block: 'center' }) } }}>Verktyg ↓</button><button type="button" onClick={onLogout}>Logga ut</button></div></details></header>
