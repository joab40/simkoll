  ...
  return (
    <div className={`page-content home${raceDayActive ? ' race-day-page' : ''}`}>
      <section className={`mood-hero ${energized ? 'energized' : ''} ${contextClass}`}>
        ...
        {profile && swimmerEffects && daysToCompetition === 0 && <div className="race-day-badge"><span className="race-flag race-flag-left" aria-hidden="true"><i /></span> RACE DAY <span className="race-flag race-flag-right" aria-hidden="true"><i /></span></div>}
