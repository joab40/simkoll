...
function Aljakten({ code, onBack, preview = false }) {
  ...
  const start = () => { const center = { x: 70, y: 240 }; gameRef.current = { ...gameRef.current, running: true, snake: [center, { x: 56, y: 240 }, { x: 42, y: 240 }], otherEels: [{ x: 210, y: 120 }, { x: 300, y: 350 }], target: { x: 160, y: 240 }, food: { x: 245, y: 220 }, score: 0, time: 0, last: performance.now(), frame: null }; setScore(0); setStatus('running'); window.setTimeout(() => gameRef.current.startLoop?.(), 0) }
