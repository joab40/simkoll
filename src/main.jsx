    ...
    <main className="coach-shell">
      ...
      <div className="coach-content">
        ...
        {loading ? <section className="empty-period"><span>≈</span><h2>Hämtar svar…</h2></section> : view === 'logs' ? (
          ...
          <CompetitionSubmissionBoundary><CompetitionCalendar code={code} onOpenSubmissions={() => setView('competition-entries')} /></CompetitionSubmissionBoundary>
