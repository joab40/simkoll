...
export default async function handler(request, response) {
  ...
  try {
    ...
    const [profiles, postsResult, groupResult, kudosResult, goalsResult] = await Promise.all([
      profilesById(),
    ...
    if (![postsResult, groupResult, kudosResult, goalsResult].every((result) => result.ok)) throw new Error('Notification lookup failed')
